        ...
        try:
            ...
            if len(server) >= 5:
                try:
                    ...
                    if server[0] in ["Hippie Station", "Yogstation 13", "BeeStation", "Bagil Station", "Terry Station", "Sybil Station", "Citadel Station", "FTL13", "Transcendent Enemy", "Sandstorm Station 13", "S.P.L.U.R.T. Station 13", "Hyper Station 13", "Nostra-13", "Nebula Station 13"]:
